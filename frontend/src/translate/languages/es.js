...
queueModal: {
  ...
  form: {
    ...
    orderQueue: "Orden de la cola",
    integrationId: "Seleccionar Integración",
    isInvisible: "Ocultar Cola",
    keyword: "Palabra clave de la Cola",
...
userModal: {
  ...
  form: {
    ...
    allTicket: "Permitir ver tickets de otras colas",
...
transferTicketModal: {
  ...
  backendErrors: {
    ...
    ERR_QUEUE_REQUIRED_WHEN_AUTOMATION_DISABLED: "La cola es obligatoria cuando la automatización está deshabilitada",
  ...
  ticketsView: "Tickets",
  ticketsViewEnabled: "Ver todos (incluso sin cola)",
