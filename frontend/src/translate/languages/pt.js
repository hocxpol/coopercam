		...
		translations: {
			...
			userModal: {
				...
				form: {
					...
					allTicket: "Permitir ver tickets de outras filas",
			...
			backendErrors: {
				...
				ERR_QUICKMESSAGE_SHORTCUT_ALREADY_EXISTS: "Este atalho já existe, escolha outro."
			},
			forward: {
			...
			ticketsView: "Tickets",
			ticketsViewEnabled: "Ver todos (inclusive sem fila)",
